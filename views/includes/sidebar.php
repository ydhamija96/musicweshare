<div id="sidebar" class="col-xs-3">
    ...
    <br>
    <!--<a href="<?php echo Config::get('base'); ?>add/"><div class="option <?php if($mode == 2){echo "active";} ?>">Add Music</div></a>
    <br>-->
    ...
    <ul class="typeList">
        <?php
            ...
            if($showAll){
                ...
                echo('<br><a href="'.Config::get('base').'all/"><li class="option '.$activeString.'">The Music We Shared</li></a>');
            }
        ?>
    </ul>
</div>
